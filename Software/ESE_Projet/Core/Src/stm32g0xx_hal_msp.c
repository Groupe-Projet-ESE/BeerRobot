...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PB3     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(TIM_Encoder1_CH1_GPIO_Port, TIM_Encoder1_CH1_Pin);

    HAL_GPIO_DeInit(TIM_Encoder1_CH2_GPIO_Port, TIM_Encoder1_CH2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, TIM_Encoder2_CH1_Pin|TIM_Encoder2_CH2_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM14_MspDeInit 0 */
    ...
    PA4     ------> TIM14_CH1
    */
    HAL_GPIO_DeInit(TIM_CC_GPIO_Port, TIM_CC_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PC5     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART_STLink_TX_Pin|UART_STLink_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD5     ------> USART2_TX
    */
    HAL_GPIO_DeInit(UART_XL320_GPIO_Port, UART_XL320_Pin);
